...
class Worker:
    ...
    def __init__(self, name='Иван', surname='Иванов', position='директор', wage=100, bonus=20):
        self.name = name
...
v_pet = Position('Василий', 'Васильевич', 'Уборщик', 110, 30)
print(f'Новыми атрибутами являются: {v_pet.name}, {v_pet.surname}, {v_pet.position}, {v_pet._income}')
print(f'Общая заработная плата: {v_pet.get_full_name()} is {v_pet.get_full_salary()}')